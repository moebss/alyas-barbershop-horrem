  ...
  return (
    <section className="relative min-h-[calc(100vh-4.5rem)] flex items-center overflow-hidden bg-[#0f0d0c] border-b border-stone-800/80 py-16 lg:py-24">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        {/* Left Aligned Floating Glass Box */}
        <div className="max-w-2xl bg-[#0f0d0c]/90 backdrop-blur-xl border border-stone-800/90 p-8 sm:p-12 rounded-3xl shadow-2xl space-y-6">
