        ...
        <div className="bg-[#1a1613] border border-stone-800/80 rounded-3xl p-6 sm:p-10 shadow-xl space-y-8">
          ...
          {step === 1 && (
            <div className="space-y-4">
              <h3 className="font-outfit font-bold text-xl text-white">1. Welchen Haarschnitt wünschen Sie?</h3>
          ...
          {step === 2 && (
            <div className="space-y-4">
              <h3 className="font-outfit font-bold text-xl text-white">2. Wie soll Ihr Bart behandelt werden?</h3>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
          ...
          {step === 3 && (
            <div className="space-y-6">
              <h3 className="font-outfit font-bold text-xl text-white">3. Wünschen Sie ein Extra-Grooming?</h3>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
              ...
              <div className="bg-[#0f0d0c] text-white p-6 rounded-2xl border border-stone-800 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-2xl">
                <div>
                  ...
                  <span className="font-outfit font-extrabold text-3xl text-white">ca. {estPrice} €</span>
